    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#universities" onClick={() => scrollToSection('universities')}>Universities</a></li>
          ...
          <div className="footer-column">
            <h3>Newsletter</h3>
            <p>Subscribe for updates on university deadlines, scholarships, and educational events.</p>
        ...
        <div className="copyright">
          <p>&copy; 2023 DragonPath Education. All rights reserved. | YueGa & Kurae</p>
        </div>
      </div>
    </footer>
  );
